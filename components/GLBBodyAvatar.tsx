...
function applyMeasurementTransforms(
  ...
  // Versi aman dulu: tidak mengubah vertex.
  // BMI 22 normal, BMI 35 besar.
  const massAmount = clamp((bmi - 22) / (35 - 22), 0, 1);

  const widthScale = 1 + massAmount * 0.35;
  const depthScale = 1 + massAmount * 0.45;
