    ...
    <main className="min-h-screen bg-black text-white px-6 py-12">
      <section className="max-w-5xl mx-auto">
        ...
        <p className="mt-6 max-w-2xl text-gray-300 text-lg">
          Design your own cycling jersey with Hazel Apparel. Choose your jersey
          type, add your body measurements, upload your design references, and
          send your custom request directly to our production team.
        </p>
